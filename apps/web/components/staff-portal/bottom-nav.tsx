...
const TABS = [
  { href: '/staff-portal',             label: 'Home',     Icon: Home,          anim: 'pulse'  as IconAnim },
  { href: '/staff-portal/tasks',       label: 'Tasks',    Icon: ClipboardList, anim: 'shake'  as IconAnim },
  { href: '/staff-portal/maintenance', label: 'Requests', Icon: Wrench,        anim: 'swing'  as IconAnim },
  { href: '/staff-portal/profile',     label: 'Profile',  Icon: User,          anim: 'bounce' as IconAnim },
]
