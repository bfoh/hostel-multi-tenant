...
const schema = z.object({
  ...
  category:       z.enum(['electronics','clothing','documents','keys','money','jewellery','bag','other']).optional(),
  ...
  status:         z.enum(['unclaimed','claimed','disposed','donated']).optional(),
  claimed_by:     z.string().max(150).optional().nullable(),
